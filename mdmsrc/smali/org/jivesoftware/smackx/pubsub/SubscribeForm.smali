...
.method public getExpiry()Ljava/util/Date;
    ...
    :try_start_0
    sget-object v0, Lorg/jivesoftware/smackx/pubsub/SubscribeForm;->format:Ljava/text/SimpleDateFormat;
    ...
    invoke-direct {v2, v1}, Ljava/util/UnknownFormatConversionException;-><init>(Ljava/lang/String;)V

    invoke-virtual {v2, v0}, Ljava/util/UnknownFormatConversionException;->initCause(Ljava/lang/Throwable;)Ljava/lang/Throwable;
...
.method public getShowValues()Ljava/util/Iterator;
    ...
    invoke-direct {p0, v0}, Lorg/jivesoftware/smackx/pubsub/SubscribeForm;->getFieldValues(Lorg/jivesoftware/smackx/pubsub/SubscribeOptionFields;)Ljava/util/Iterator;

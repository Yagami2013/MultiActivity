...
.method public static parseIQ(Lorg/xmlpull/v1/XmlPullParser;Lorg/jivesoftware/smack/Connection;)Lorg/jivesoftware/smack/packet/IQ;
    ...
    :cond_9
    new-instance v1, Lorg/jivesoftware/smack/util/PacketParserUtils$2;

    invoke-direct {v1}, Lorg/jivesoftware/smack/util/PacketParserUtils$2;-><init>()V

    :cond_a
    invoke-virtual {v1, v5}, Lorg/jivesoftware/smack/packet/IQ;->setPacketID(Ljava/lang/String;)V

    invoke-virtual {v1, v6}, Lorg/jivesoftware/smack/packet/IQ;->setTo(Ljava/lang/String;)V

    invoke-virtual {v1, v7}, Lorg/jivesoftware/smack/packet/IQ;->setFrom(Ljava/lang/String;)V

    invoke-virtual {v1, v8}, Lorg/jivesoftware/smack/packet/IQ;->setType(Lorg/jivesoftware/smack/packet/IQ$Type;)V

    invoke-virtual {v1, v4}, Lorg/jivesoftware/smack/packet/IQ;->setError(Lorg/jivesoftware/smack/packet/XMPPError;)V
...
.method public static parseMessage(Lorg/xmlpull/v1/XmlPullParser;)Lorg/jivesoftware/smack/packet/Packet;
    ...
    :cond_b
    invoke-virtual {v5, v4}, Lorg/jivesoftware/smack/packet/Message;->setThread(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v0, v2}, Lorg/jivesoftware/smack/packet/Message;->setProperty(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private static parseRegistration(Lorg/xmlpull/v1/XmlPullParser;)Lorg/jivesoftware/smack/packet/Registration;
    ...
    invoke-virtual {v2, v4}, Lorg/jivesoftware/smack/packet/Registration;->setInstructions(Ljava/lang/String;)V

    goto :goto_0

    :cond_1
    invoke-virtual {v2, v3, v4}, Lorg/jivesoftware/smack/packet/Registration;->addAttribute(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v1}, Lorg/jivesoftware/smack/packet/Registration;->setRegistered(Z)V

    goto :goto_0

    :cond_3
    invoke-virtual {v2, v3}, Lorg/jivesoftware/smack/packet/Registration;->addRequiredField(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Lorg/jivesoftware/smack/packet/Registration;->addExtension(Lorg/jivesoftware/smack/packet/PacketExtension;)V
